...
void main() async {
  ...
  autosuggest = await api.autosuggest('filled.count.soap', options: options).execute();
  ...
  options = AutosuggestOptions().setInputType(AutosuggestInputType.VOCON_HYBRID).setLanguage('en');
  autosuggest = await api
      .autosuggest(
